...
export const MOCK_CLIENTS: Client[] = [
  ...
  /* Clients référencés par les commandes closing (sinon « Voir client » → 404) */
  {
    id: "cu_khady_niang",
    name: "Khady Niang",
    ...
    totalDeliveredOrders: 1,
    totalCancelledOrders: 0,
    totalSpentXof: 22_000,
    avgBasketXof: 22_000,
    preferredProductIds: ["p_lunettes"],
  ...
  },
  {
    ...
    avgBasketXof: 0,
    preferredProductIds: [],
    notes: "Commande annulée : faux numéro. À vérifier avant relance.",
  ...
  },
  {
    ...
    totalDeliveredOrders: 2,
    totalCancelledOrders: 0,
    totalSpentXof: 56_000,
    avgBasketXof: 28_000,
    preferredProductIds: ["p_casquette"],
