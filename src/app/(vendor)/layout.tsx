...
/**
 * Layout vendeur — englobe les routes de la console (sidebar + topbar,
 * desktop-only). L'espace public Partenaires (marketplace) vit désormais dans
 * le groupe de routes `(partners)` avec sa propre coque.
 *
 * Responsive :
  ...
  return (
    <ChatProvider>
      <TopbarSlotProvider>
        ...
        >
          {/* Recherche globale (Ctrl+K) — montée une seule fois pour la console */}
          <GlobalSearch />
          <ShopifyAutoSync />
